  ...
  try {
    ...
    if (error instanceof Error) {
      if (error.message.includes('Sender')) {
        errorMessage = 'Email sender not verified. Please verify your email address in AWS SES.';
      } else if (error.message.includes('Recipient')) {
        errorMessage = 'Email recipient not verified. Please verify the recipient email address in AWS SES.';
      } else {
