...
export default function GuideCard({
  ...
  return (
    <Link href={`/guides/${encodeURIComponent(slug)}`}>
      <article
        className="group rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-full flex flex-col"
        style={{
